...
FIND_PROGRAM( GCOVR_EXECUTABLE gcovr PATHS ${CMAKE_SOURCE_DIR}/tests)
...
function(blt_add_code_coverage_target)
    ...
    set(multiValueArgs RUNNER SOURCE_DIRECTORIES REMOVE)
    ...
    add_custom_target(${arg_NAME}
        ...
        COMMAND ${LCOV_EXECUTABLE} --no-external --gcov-tool ${GCOV_EXECUTABLE} ${_coverage_directories} --remove ${arg_NAME}.info ${arg_REMOVE} '/usr/include/*' --output-file ${arg_NAME}.info.cleaned
