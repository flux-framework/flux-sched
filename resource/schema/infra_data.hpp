...
class relation_infra_t : public infra_base_t {
   public:
    enum class slot_role_t : int { NONE = -1, MEMBER = 0, LEADER = 1 };
    ...
    slot_role_t get_slot_role () const;
    void set_slot_role (slot_role_t);
    bool is_slot_leader ();
   ...
   private:
    ...
    int m_exclusive = 0;
    slot_role_t m_slot_role = slot_role_t::NONE;
};
