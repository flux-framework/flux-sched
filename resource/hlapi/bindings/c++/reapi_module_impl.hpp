                                    ...
                                    std::string &R, int64_t &at, double &ov)
{
    ...
    if (!(f = flux_rpc_pack (fh, "fluxion-resource.match", FLUX_NODEID_ANY, 0,
                             "{s:s s:I s:s}",
...
int reapi_module_t::cancel (void *h, const uint64_t jobid)
{
    ...
    if (!(f = flux_rpc_pack (fh, "fluxion-resource.cancel", FLUX_NODEID_ANY, 0,
                          ...
                          bool &reserved, int64_t &at, double &ov)
{
    ...
    if (!(f = flux_rpc_pack (fh, "fluxion-resource.info", FLUX_NODEID_ANY, 0,
                             "{s:I}", "jobid", (const int64_t)jobid))) {
        goto out;
    }
                          ...
                          double &load, double &min, double &max, double &avg)
{
    ...
    if (!(f = flux_rpc (fh, "fluxion-resource.stat",
