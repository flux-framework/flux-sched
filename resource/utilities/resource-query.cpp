...
"            (default=CA).\n"
"\n"
"    -P, --match-policy=<low|high|lonode|hinode|first|locality|variation>\n"
...
"                        low ID first otherwise (e.g., node-lcal resource types \n"
"                hinode: Select resources with highest node ID first, \n"
"                        high ID first otherwise (e.g., node-lcal resource types \n"
