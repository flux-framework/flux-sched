...
class match_writers_t {
   public:
     ...
     */
    virtual bool emit_exclusive_subtrees (void)
    {
        return true;
    }
};
...
class jgf_shorthand_match_writers_t : public jgf_match_writers_t {
   public:
    jgf_shorthand_match_writers_t () : jgf_match_writers_t ()
    {
    }
    jgf_shorthand_match_writers_t (const jgf_shorthand_match_writers_t &w) : jgf_match_writers_t (w)
    {
    }
    jgf_shorthand_match_writers_t &operator= (const jgf_shorthand_match_writers_t &w);

    virtual bool emit_exclusive_subtrees (void) override
    {
        return false;
    }
};
