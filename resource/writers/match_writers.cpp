...
int jgf_match_writers_t::emit_edg_meta (json_t *o, const f_resource_graph_t &g, const edg_t &e)
{
    int rc = 0;
    if (!o) {
        rc = -1;
...
int rlite_match_writers_t::emit_gatherer (const f_resource_graph_t &g, const vtx_t &u)
{
    int rc = 0;
    std::string children;
