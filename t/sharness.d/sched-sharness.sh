...
if test -n "$FLUX_SCHED_TEST_INSTALLED"; then
  ...
  FLUX_MODULE_PATH_PREPEND="${SHARNESS_BUILD_DIRECTORY}/src/resource/modules/"
  FLUX_MODULE_PATH_PREPEND="${SHARNESS_BUILD_DIRECTORY}/src/resource/modules/.libs":${FLUX_MODULE_PATH_PREPEND}
  FLUX_MODULE_PATH_PREPEND="${SHARNESS_BUILD_DIRECTORY}/src/qmanager/modules/":${FLUX_MODULE_PATH_PREPEND}
  FLUX_MODULE_PATH_PREPEND="${SHARNESS_BUILD_DIRECTORY}/src/qmanager/modules/.libs":${FLUX_MODULE_PATH_PREPEND}
