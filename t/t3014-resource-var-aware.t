...
test_expect_success "${test001_desc}" '
    ...
    ${query} -G ${grugs} -S CA -P variation -t 001.R.out < cmds001 &&
...
test_expect_success "${test002_desc}" '
    ...
    ${query} -G ${grugs} -S CA -P variation -t 002.R.out < cmds002 &&
...
test_expect_success "${test003_desc}" '
    ...
    ${query} -G ${grugs} -S CA -P variation -t 003.R.out < cmds003 &&
...
test_expect_success "${test004_desc}" '
    ...
    ${query} -G ${grugs} -S CA -P variation -t 004.R.out < cmds004 &&
...
test_expect_success "${test005_desc}" '
    ...
    ${query} -G ${grugs} -S CA -P variation -t 005.R.out < cmds005 &&
