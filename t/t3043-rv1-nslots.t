...
test_expect_success "${test001_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -t 001.R.out < cmds001 &&
...
test_expect_success "${test002_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -t 002.R.out < cmds002 &&
...
test_expect_success "${test003_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -t 003.R.out < cmds003 &&
...
test_expect_success "${test004_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -t 004.R.out < cmds004 &&
...
test_expect_success "${test005_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -t 005.R.out < cmds005 &&
...
test_expect_success "${test006_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P first -t 006.R.out < cmds006 &&
...
test_expect_success "${test007_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_nslots -S CA -P high -T flexible -t 007.R.out < cmds007 &&
