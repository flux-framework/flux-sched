...
test_expect_success "${test001_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -t 001.R.out < cmds001 &&
    test_cmp 001.R.out ${exp_dir}/015.R.out
'
...
test_expect_success "${test002_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -t 002.R.out < cmds002 &&
    test_cmp 002.R.out ${exp_dir}/016.R.out
'
...
test_expect_success "${test003_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -t 003.R.out < cmds003 &&
    test_cmp 003.R.out ${exp_dir}/017.R.out
'
...
test_expect_success "${test004_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -t 004.R.out < cmds004 &&
    test_cmp 004.R.out ${exp_dir}/018.R.out
'
...
test_expect_success "${test005_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -t 005.R.out < cmds005 &&
    test_cmp 005.R.out ${exp_dir}/019.R.out
'
...
test_expect_success "${test006_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P first -t 006.R.out < cmds006 &&
    test_cmp 006.R.out ${exp_dir}/020.R.out
'
...
test_expect_success "${test007_desc}" '
    ...
    ${query} -L ${jgf} -f jgf -F rv1_shorthand_nslots -S CA -P high -T flexible -t 007.R.out < cmds007 &&
    test_cmp 007.R.out ${exp_dir}/021.R.out
'
